...
import com.MTG.ucrop.model.CropParameters;
import com.MTG.ucrop.model.ExifInfo;
import com.MTG.ucrop.model.ImageState;
import com.MTG.ucrop.util.FileUtils;
import com.MTG.ucrop.util.ImageHeaderParser;
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private int mCropOffsetX, mCropOffsetY;
    ...
    private boolean crop(float resizeScale) throws IOException {
        ...
        mCropOffsetX = Math.round((mCropRect.left - mCurrentImageRect.left) / mCurrentScale);
        mCropOffsetY = Math.round((mCropRect.top - mCurrentImageRect.top) / mCurrentScale);
        ...
        if (shouldCrop) {
            boolean cropped = cropCImg(mImageInputPath, mImageOutputPath,
                    mCropOffsetX, mCropOffsetY, mCroppedImageWidth, mCroppedImageHeight,
    ...
    protected void onPostExecute(@Nullable Throwable t) {
        if (mCropCallback != null) {
            if (t == null) {
                mCropCallback.onBitmapCropped(mImageOutputPath, mCropOffsetX, mCropOffsetY, mCroppedImageWidth, mCroppedImageHeight);
            } else {
