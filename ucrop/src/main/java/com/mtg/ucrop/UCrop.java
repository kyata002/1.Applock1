...
public class UCrop {
    ...
    private static final String EXTRA_PREFIX = "com.actappsworld.applock";

    public static final String EXTRA_INPUT_PATH = EXTRA_PREFIX + ".InputPath";
    public static final String EXTRA_OUTPUT_PATH = EXTRA_PREFIX + ".OutputPath";
     ...
     */
    public static UCrop of(@NonNull String source, @NonNull String destination) {
        return new UCrop(source, destination);
    }

    private UCrop(@NonNull String source, @NonNull String destination) {
        mCropIntent = new Intent();
        mCropOptionsBundle = new Bundle();
        mCropOptionsBundle.putString(EXTRA_INPUT_PATH, source);
        mCropOptionsBundle.putString(EXTRA_OUTPUT_PATH, destination);
    }
    ...
    public void start(@NonNull Activity activity, Class<?> mClass) {
        mCropIntent.setClass(activity, mClass);
        mCropIntent.putExtras(mCropOptionsBundle);
        activity.startActivityForResult(mCropIntent, REQUEST_CROP);
    }

    public void start(@NonNull Fragment fragment, Class<?> mClass) {
        mCropIntent.setClass(fragment.requireContext(), mClass);
        mCropIntent.putExtras(mCropOptionsBundle);
        fragment.startActivityForResult(mCropIntent, REQUEST_CROP);
    }
     ...
     */
    @Nullable
    public static String getOutputPath(@NonNull Intent intent) {
        return intent.getStringExtra(EXTRA_OUTPUT_PATH);
    }
