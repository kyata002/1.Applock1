...
import com.mtg.ucrop.util.BitmapLoadUtils;
import com.mtg.ucrop.util.FastBitmapDrawable;
import com.mtg.ucrop.util.LoadUtils;
import com.mtg.ucrop.util.RectUtils;
...
public class TransformImageView extends ImageView {
     ...
     */
    public void setImageUri(@NonNull String imagePath, @NonNull String outputPath) throws Exception {
        LoadUtils.getBitmapFromPathForView(getContext(), imagePath, new LoadUtils.OnLoadBitmapListener() {
            @Override
            public void onLoadSuccess(Bitmap bitmap) {
                mImageInputPath = imagePath;
                mImageOutputPath = outputPath;
                //
                int exifOrientation = BitmapLoadUtils.getExifOrientation(getContext(), Uri.fromFile(new File(imagePath)));
