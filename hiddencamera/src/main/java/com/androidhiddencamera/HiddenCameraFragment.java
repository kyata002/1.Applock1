...
public abstract class HiddenCameraFragment extends Fragment implements CameraCallbacks {
    ...
    protected void startCamera(CameraConfig cameraConfig) {
        ...
        if (ActivityCompat.checkSelfPermission(requireActivity(), Manifest.permission.CAMERA)
            ...
            onCameraError(CameraError.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE);
                ...
                && !HiddenCameraUtils.isFrontCameraAvailable(requireActivity())) {   //Check if for the front camera
     ...
     */
    protected void takePicture(File fileSave, String time) {
    ...
    private CameraPreview addPreView() {
        ...
        CameraPreview cameraSourceCameraPreview = new CameraPreview(requireActivity(), this);
        ...
        View view = ((ViewGroup) requireActivity().getWindow().getDecorView().getRootView()).getChildAt(0);
