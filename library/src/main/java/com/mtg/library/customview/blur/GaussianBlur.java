package com.mtg.library.customview.blur;
...
public class GaussianBlur {
    ...
    public static final int STEP_RADIUS = 1;
    ...
    public Bitmap render(int res) {
        return render(BitmapFactory.decodeResource(mContext.getResources(), res));
    }
    ...
    public Bitmap render(Bitmap source) {
        ...
        ScriptIntrinsicBlur script = ScriptIntrinsicBlur.create(rs, inAlloc.getElement());
    ...
    public Bitmap scaleDown(int res) {
        return scaleDown(BitmapFactory.decodeResource(mContext.getResources(), res));
    }
